...
class Round extends React.Component {
    render() {
        let {game, hand, opponentHand, settings, score, validPieces, winner, selectCard, resetStep, playerTakesTurn} = this.props;
        ...
        return (
            <div id="step-2">
                ...
                <GameOverBanner winner={winner} score={score} resetStep={resetStep}/>
